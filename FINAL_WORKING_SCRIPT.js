// FINAL WORKING Google Apps Script for Property File Upload
// Copy this ENTIRE code and replace ALL existing code in your Google Apps Script editor

const FOLDER_ID = '1mUaBxx15Se_cN3s0UoIxbCenA2PCjEfn';

function doGet(e) {
  const response = {
    status: 'ok',
    message: 'Google Drive Upload API is running - Updated Version',
...
function doPost(e) {
  try {
    Logger.log('=== GOOGLE DRIVE UPLOAD START ===');
